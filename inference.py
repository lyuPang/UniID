...
if __name__ == "__main__":
    ...
    inference = Inference(
        ...
        pretrained_face_recog_model_path="pretrained_model_weights/glint360k_cosface_r100_fp16_0.1/backbone.pth",
        insightface_root=args.insightface_root,
        # num_text_branch_tokens=text_branch_config['num_text_branch_tokens'] if text_branch_config is not None else None,
        ...
        # num_adapter_tokens=adapter_branch_config['num_adapter_tokens'] if adapter_branch_config is not None else None,
        num_adapter_tokens=25,
        normalize_adapter_output=args.normalize_adapter_output,
        adapter_hidden_dim=adapter_branch_config['adapter_hidden_dim'] if adapter_branch_config is not None else None,
